...
import { Container, IdTextContainer, IdText, DescricaoText, DescricaoTextContainer, ButtonContainer, CustomButton, ButtonText } from './styles';
            ...
            <Container {...rest} style={{
                ...
                <View style={{ flexDirection: 'row' }}>
                    <Timeline
                        ...
                        detailContainerStyle={{ marginTop: -10, marginBottom: 20, paddingLeft: 5, paddingRight: 5, backgroundColor: "#fff", marginRight: 32 }}
                        descriptionStyle={{ color: '#fff' }}
                        titleStyle={{ color: '#4271ffd9', fontSize: 16, fontFamily: 'Archivo_700Bold' }}
                        timeContainerStyle={{backgroundColor: '#4271ffd9', borderRadius: 16, padding: 4}}
                        timeStyle={{color: '#fff', fontSize: 12, fontFamily: 'Archivo_400Regular'}}
